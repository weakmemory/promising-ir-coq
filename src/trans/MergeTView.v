...
Lemma write_read_tview
      ...
      (WF0: TView.wf tview0):
  TView.le
    (TView.read_tview (TView.write_tview tview0 loc ts ord1) loc ts
       (Some ((TView.rel (TView.write_tview tview0 loc ts ord1)) loc))
       ord2)
    (TView.write_tview tview0 loc ts ord1).
Proof.
...
Lemma write_write_tview
      ...
      (WF0: TView.wf tview0):
  TView.le
    (TView.write_tview (TView.write_tview tview0 loc ts1 ord) loc ts2 ord)
    (TView.write_tview tview0 loc ts2 ord).
Proof.
